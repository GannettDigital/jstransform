...
func (r *Contributors_record) Schema() string {
	return "{\"fields\":[{\"name\":\"contributorId\",\"namespace\":\"contributors\",\"type\":[\"null\",\"string\"]},{\"name\":\"id\",\"namespace\":\"contributors\",\"type\":\"string\"},{\"name\":\"name\",\"namespace\":\"contributors\",\"type\":\"string\"}],\"name\":\"contributors.contributors_record\",\"type\":\"record\"}"
}

func (r *Contributors_record) SchemaName() string {
	return "contributors.contributors_record"
}
