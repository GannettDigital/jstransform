			...
			for za0001 := range z.Crops {
				...
				for zb0003 > 0 {
					...
					case "Height":
						...
						if err != nil {
							err = msgp.WrapError(err, "Crops", za0001, "Height")
							return
						}
					case "Name":
						z.Crops[za0001].Name, err = dc.ReadString()
						if err != nil {
							err = msgp.WrapError(err, "Crops", za0001, "Name")
							return
						}
					case "Path":
						z.Crops[za0001].Path, err = dc.ReadString()
						if err != nil {
							err = msgp.WrapError(err, "Crops", za0001, "Path")
							return
						}
					case "RelativePath":
						z.Crops[za0001].RelativePath, err = dc.ReadString()
						if err != nil {
							err = msgp.WrapError(err, "Crops", za0001, "RelativePath")
							return
						}
					case "Width":
						z.Crops[za0001].Width, err = dc.ReadFloat64()
						if err != nil {
							err = msgp.WrapError(err, "Crops", za0001, "Width")
							return
						}
					default:
						err = dc.Skip()
		...
		case "URL":
			...
			for zb0005 > 0 {
				...
				case "Absolute":
					...
					if err != nil {
						err = msgp.WrapError(err, "URL", "Absolute")
						return
					}
				case "Meta":
					var zb0006 uint32
					...
					if err != nil {
						err = msgp.WrapError(err, "URL", "Meta")
						return
					}
					for zb0006 > 0 {
						zb0006--
						...
						case "Description":
							...
							if err != nil {
								err = msgp.WrapError(err, "URL", "Meta", "Description")
								return
							}
						case "SiteName":
							z.URL.Meta.SiteName, err = dc.ReadString()
							if err != nil {
								err = msgp.WrapError(err, "URL", "Meta", "SiteName")
								return
							}
						default:
							err = dc.Skip()
				...
				case "Publish":
					...
					if err != nil {
						err = msgp.WrapError(err, "URL", "Publish")
						return
					}
				default:
					err = dc.Skip()
