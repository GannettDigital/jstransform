...
func BuildStructs(schemaPath string, outputDir string, useMessagePack bool) error {
	return BuildStructsRename(schemaPath, outputDir, useMessagePack, nil)
}

// BuildStructsRename takes a JSON Schema and generates Golang structs that match the schema.
