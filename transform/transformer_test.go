...
var (
	...
	transformerTests = []struct {
		...
		},
		{
			...
			want: json.RawMessage(`{"caseSplit":["a","b","c","d"],"contributor":"two","duration":13,"startTime":"09:00","toCamelCase":"extraBaseHit","url":"http://gannettdigital.com/blah","valid":true}`),
		},
		{
